...
if __name__ == '__main__':
    PP = [{'Name': '吕卓', 'ID': '450821198807025619'},
          {'Name': '陈舒伟', 'ID': '452501198505017437'},
          {'Name': '岑鹏飞', 'ID': '330381198710130916'},
          {'Name': '叶飞阳', 'ID': '330327197412077149'},
          {'Name': '张可忠', 'ID': '330327197304056092'},
          {'Name': '陈照花', 'ID': '330327194202230420'},
          {'Name': '林宣煊', 'ID': '330327196206290040'},
          {'Name': '曾薇薇', 'ID': '330327198701290426'},
          {'Name': '朱思阁', 'ID': '352231195910220011'},
          {'Name': '朱为国', 'ID': '33032719401107041X'},
          {'Name': '朱琰', 'ID': '33032720140616005X'},
          {'Name': '杨忠将', 'ID': '330326197911194116'}]
    for i in PP:
        for k,v in i.items():
            if 'Name' in k:
                print(v)
